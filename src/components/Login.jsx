...
export default function Login({ users, onLogin }) {
  ...
  return (
    <div className="min-h-[90vhs] bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xs w-full max-w-sm p-8">
        {/* Header */}
